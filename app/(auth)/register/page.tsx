  ...
  return (
    <div className="flex min-h-screen">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 lg:p-16 xl:p-20 text-white">
          <div className="animate-fade-in-up">
            ...
            <p className="text-xl opacity-90 max-w-md">
              Join professionals who are landing better opportunities with AI-enhanced CVs.
            </p>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-background">
        <div className="w-full max-w-md space-y-8 py-12 animate-fade-in-up stagger-1">
